...
define('NICUPLOAD_PATH', '../../uploads/blog/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http://localhost/impeesa2/uploads/blog/');   // Set the URL (relative or absolute) to
